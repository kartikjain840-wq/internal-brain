...
# ---------- GOOGLE DRIVE ----------
st.subheader("🔗 Google Drive Folder Access")
...
if st.button("Load Files from Google Drive") and drive_url:
...
if os.path.exists(DOWNLOAD_DIR):
    ...
    if files:
        ...
        with col2:
            ...
            st.success(summarize_text(raw_text))
        ...
        st.info("No supported files found yet.")
